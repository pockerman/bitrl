...
bool RESTRLEnvClient::is_env_registered(const std::string &env_name) const noexcept
{
...
void RESTRLEnvClient::register_new(const std::string &name, const std::string &uri)
{
...
void RESTRLEnvClient::register_if_not(const std::string &name, const std::string &uri)
{
...
std::string RESTRLEnvClient::get_uri(const std::string &name) const noexcept
{
...
std::string RESTRLEnvClient::get_env_url(const std::string &name) const noexcept
{
...
nlohmann::json RESTRLEnvClient::is_alive(const std::string &env_name, const std::string &idx) const
{
...
nlohmann::json RESTRLEnvClient::close(const std::string &env_name, const std::string &idx) const
{
...
nlohmann::json RESTRLEnvClient::make(const std::string &env_name, const std::string &version,
...
nlohmann::json RESTRLEnvClient::dynamics(const std::string &env_name, const std::string &idx,
...
bool RESTRLEnvClient::has_gymnasium() const
{
...
std::vector<std::string> RESTRLEnvClient::gymnasium_envs() const
{
