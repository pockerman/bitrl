...
CartPole::create_time_step_from_response_(const nlohmann::json &response) const
{
    ...
    return CartPole::time_step_type(TimeStepEnumUtils::time_step_type_from_int(step_type), reward,
...
void CartPole::make(const std::string &version,
...
CartPole::time_step_type CartPole::step(const action_type &action)
{
