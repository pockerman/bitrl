 ...
 *  is described here:
 *https://github.com/openai/gym/blob/master/gym/envs/classic_control/cartpole.py The state variables
 *are:
 *
 * Observation:
 *      Type: Box(4)
...
///
class CartPole final
    : public GymnasiumEnvBase<TimeStep<std::vector<real_t>>,
                              ContinuousVectorStateDiscreteActionEnv<4, 2, 0, real_t>>
{
