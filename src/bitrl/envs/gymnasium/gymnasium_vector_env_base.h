...
template <typename VectorTimeStepType, typename SpaceType>
GymnasiumVecEnvBase<VectorTimeStepType, SpaceType>::GymnasiumVecEnvBase(
...
template <typename VectorTimeStepType, typename SpaceType>
GymnasiumVecEnvBase<VectorTimeStepType, SpaceType>::GymnasiumVecEnvBase(
    const GymnasiumVecEnvBase<VectorTimeStepType, SpaceType> &other)
...
template <typename VectorTimeStepType, typename SpaceType>
void GymnasiumVecEnvBase<VectorTimeStepType, SpaceType>::make(
