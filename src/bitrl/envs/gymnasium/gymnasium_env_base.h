...
class GymnasiumEnvBase : public EnvBase<TimeStepType, SpaceType>
{
  ...
  protected:
    ...
    create_time_step_from_response_(const nlohmann::json &response) const = 0;
};

template <typename TimeStepType, typename SpaceType>
GymnasiumEnvBase<TimeStepType, SpaceType>::GymnasiumEnvBase(network::RESTRLEnvClient &api_server,
                                                            const std::string &name)
    : EnvBase<TimeStepType, SpaceType>(bitrl::consts::INVALID_STR, name), api_server_(&api_server)
{
}

template <typename TimeStepType, typename SpaceType>
GymnasiumEnvBase<TimeStepType, SpaceType>::GymnasiumEnvBase(
    const GymnasiumEnvBase<TimeStepType, SpaceType> &other)
...
template <typename TimeStepType, typename SpaceType>
bool GymnasiumEnvBase<TimeStepType, SpaceType>::is_alive() const
{
...
template <typename TimeStepType, typename SpaceType>
void GymnasiumEnvBase<TimeStepType, SpaceType>::close()
{
...
template <typename TimeStepType, typename SpaceType>
std::string GymnasiumEnvBase<TimeStepType, SpaceType>::get_url() const
{
