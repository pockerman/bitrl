...
struct ScalarDiscreteEnv
{
    ...
    {
        return action_space::sample(seed, size, true);
    }
};

template <uint_t StateSpaceSize, uint_t action_end, uint_t action_start = 0,
...
template <uint_t StateSpaceSize, uint_t ActionSpaceSize, typename StateSpaceItemType = real_t,
...
template <uint_t StateSpaceSize, uint_t action_end, typename real_range, uint_t action_start = 0,
          typename StateSpaceItemType = real_t>
