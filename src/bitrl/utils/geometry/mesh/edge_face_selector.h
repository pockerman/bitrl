...
template <int dim, int topodim> struct EdgeType;

template <int dim> struct EdgeType<dim, 0>
{
...
template <int dim> struct EdgeType<dim, 1>
{
...
template <int dim> struct EdgeSelector
{
