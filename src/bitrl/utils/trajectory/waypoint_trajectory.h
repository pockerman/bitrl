...
/// will look like
///
template <typename LinkType> class WaypointTrajectory
{
  public:
...
template <typename LinkType> WaypointTrajectory<LinkType>::WaypointTrajectory() : links_() {}

template <typename LinkType> WaypointTrajectory<LinkType>::WaypointTrajectory(uint_t n) : links_()
{
    links_.resize(n);
}
...
WaypointTrajectory<LinkType>::distance(
    const typename WaypointTrajectory<LinkType>::w_point_type &p) const
{
