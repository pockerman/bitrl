...
inline IterativeAlgorithmController::IterativeAlgorithmController(uint_t max_iterations,
                                                                  real_t exit_tolerance)
    : max_iterations_(max_iterations), exit_tolerance_(exit_tolerance), current_iteration_idx_(0),
      n_threads_(1), current_res_(std::numeric_limits<real_t>::max()), show_iterations_(false),
