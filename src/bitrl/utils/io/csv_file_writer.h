...
class CSVWriter : public FileWriterBase
{
  ...
  public:
    ...
    ///
    template <typename T> void write_column_vector(const std::vector<T> &vals);
...
template <typename T> void CSVWriter::write_row(const std::vector<T> &vals)
{
...
template <typename T> void CSVWriter::write_row(const DynVec<T> &vals)
{
...
template <typename T> void CSVWriter::write_column_vector(const std::vector<T> &vals)
{
...
template <typename... T> void CSVWriter::write_row(const std::tuple<T...> &row)
{
