...
void VtkMeshFileWriter::write_header()
{
...
void VtkMeshFileWriter::write_mesh(const Mesh<2> &mesh)
{
    ...
    this->file_ << std::endl;
    this->file_ << "CELLS " << n_elements << " " << n_elements * ele_n_nodes + n_elements
                << std::endl;
...
void VtkMeshFileWriter::write_mesh(const Mesh<2> &mesh, const VtkMeshMeshCellOptions &options)
{
...
void VtkMeshFileWriter::write_mesh(const Mesh<2> &mesh, const std::vector<real_t> &cell_values,
...
void VtkMeshFileWriter::write_option(const Mesh<2> &mesh, const std::string &name)
{
