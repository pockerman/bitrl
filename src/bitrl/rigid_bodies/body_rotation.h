...
inline RBRotation::RBRotation() : RBRotation({0.0, 0.0, 0.0}) {}

inline RBRotation::RBRotation(std::initializer_list<real_t> vals) : x(0.0), y(0.0), z(0.0)
{
...
inline std::ostream &operator<<(std::ostream &out, const RBRotation &info)
{
